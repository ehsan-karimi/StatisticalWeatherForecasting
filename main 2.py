...
def eda_analysis(train_data, target_col='degC'):
    ...
    print("\nStationarity Tests:")
    print("ADF Test:")
    adf_test = adfuller(train_data[target_col].dropna())
    ...
    print("\nKPSS Test:")
    kpss_test = kpss(train_data[target_col].dropna())
    ...
    print("\nKPSS Test (Constant):")
    kpss_test_c = kpss(train_data[target_col].dropna(), regression='c')
    print(f'KPSS Statistic: {kpss_test_c[0]}')
    print(f'p-value: {kpss_test_c[1]}')

    print("\nKPSS Test (Constant + Trend):")
    kpss_test_ct = kpss(train_data[target_col].dropna(), regression='ct')
